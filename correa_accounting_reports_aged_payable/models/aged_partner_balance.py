...
class ReportAccountAgedPartner(models.AbstractModel):
    ...
    @api.model
    def _get_sql(self):
        '''Redefined for add the bill_reference field in the sql.'''
        ...
        query = ("""
            SELECT
                ...
                COALESCE(move.invoice_date, account_move_line.date_maturity, account_move_line.date) AS report_date,
                COALESCE(account_move_line.expected_pay_date, account_move_line.date_maturity, account_move_line.date) AS expected_pay_date,
